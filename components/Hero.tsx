    ...
    >
      <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <div className="relative mx-auto w-full max-w-sm">
          <p className="mb-4 inline-flex self-center rounded-full border-2 border-primary/40 bg-white px-7 py-3 text-base font-extrabold uppercase tracking-[0.2em] text-primary shadow-[0_10px_28px_rgba(180,83,201,0.28)] ring-2 ring-primary/10">
            {copy.heroBadge}
          </p>
          <div className="mb-4 flex justify-center">
            <p className="relative max-w-xs rounded-2xl border border-primary/30 bg-white px-4 py-2.5 text-center text-sm font-semibold text-primary shadow-sm">
              {copy.heroIntro}
              <span
                aria-hidden
