import { FUTURE_FEATURES } from "@/lib/content";
  ...
  return (
    <section id="future" className="scroll-mt-20 border-t border-zinc-200 bg-zinc-50 px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-5xl">
        <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 sm:text-4xl">On the roadmap</h2>
        <p className="mt-3 max-w-2xl text-lg text-zinc-600">
          We&apos;re shipping the core experience first. Here&apos;s what we&apos;re planning next—timelines may
          change as we learn from early users.
        </p>
